...
class UserList extends Component {
    ...
    render() {
        let {user,  showDetail, message, showUpdate, deleteUser } = this.props;
        let allResult = user.map((data) =>
            <tr className="table-danger" style={{ color: "black" }}>
                ...
                <td>
                    ...
                    <button className="btn-delete" onClick={() => deleteUser(data.id_user)}><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
